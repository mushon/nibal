...
`תושון, צריך לבדוק למה חסרים פוליגונים בצפון + לדעתי להוריד את הסימון של האיזור ההומניטרי באל-מוואסי מהמפה - זה מבלבל`
...
התחתנתי איתו מרות ההתנגדות של ההורים שלי. ידעתי שלא יהיו לנו חיי שפע, אבל הרגשתי שהוא הזהב שלי.
...
{.meta} 
[](map/#31.52287,34.46534,12.90,-3.2,39.0/+family-home,+unosat-damage-231015,+cities "ההרס באיזור ג׳אבליא בסוף אוקטובר 2023. מקור: UNOSAT")
...
{.meta} 
ברבות חודשי המתקפה, תועד כי העצורים והכלואים הפלסטינים סובלים מאלימות תכופה, קשה ושרירותית, שהפכה מאז אוקטובר 2023 למדיניות מערכתית של ישראל כלפי אסירים פלסטינים. 

על פי רוב, ישראל שוללת מהם זכויות יסוד, בהן הזכות לייצוג משפטי, תוך סירוב למסור מידע בסיסי אודותיהם ולגבי תנאי הכליאה שלהם. 
...
ב-6 במאי 2024, פחות מחודשיים לאחר הגעתם של ניבאל, אחמד וריתא לעיר, מפיץ הצבא הישראלי צווי פינוי חדשים הדורשים מתושבי רפיח להתפנות.  
...
החיים במחסן היו קצת יציבים יותר, אבל הייתי ברגשות מעורבים. המרחק מהמשפחה ומהבית שלי גרם לי להרגיש בודדה ומנוכרת.  
מצד שני, שמחתי להיות עם בעלי והבת שלי. 

מתי שהצלחתי, התעדכנתי בטלפון במצב של המשפחה בג׳אבליא.
...
היינו שם בערך חמישה חודשים. חיינו בתנאים לא פשוטים, אבל הרגשתי שלאט לאט הצלחנו למצוא קצת נחת.
...
אחרי כחודשיים של חיים באוהל באל-מוואסי, בינואר 2025 מתבשרת ניבאל על כניסתה לתוקף של הפסקת האש בין ישראל לחמאס. 
...
במהלך התקופה השנייה באוהל באל-מוואסי, מערכת היחסים של ניבאל ואחמד נכנסת למשבר.
...
{.meta}
בתחילת יוני 2025, כשלושה חודשים לאחר ששבה עם ריתא לאל-מוואסי, ניבאל מקבלת את ההחלטה לחזור איתה לבית הוריה.


{.meta}
[](embed/#vimeo.com%2F1133751988%3Fshare%3Dcopy%26fl%3Dsv%26fe%3Dci/autoplay,loop,auto)
אחיין של ניבאל מגיע לאסוף אותן מאל-מוואסי. ניבאל מתארת נסיעה רוויית אימה, במהלכה היא מביטה מבעד לחלון המכונית ורואה כיצד אזורים שלמים סביבם נתונים להפצצות כבדות. 
...
הגענו הביתה בשלום. המשפחה שוב קיבלה את פנינו באהבה, אבל בבית היה עצב כבד. אני ואחותי, שאיבדה את שלושת ילדיה, ניסינו לנחם אחת את השנייה.


{.testimony typewriter}
[](img/#nibal_home_smile2.heic)

לא יכולתי לעשות כלום בעצמי והתקשיתי לטפל בריתא. 
...
לאחר שביתם נהרס, ניבאל, ריתא וכ-50 מבני משפחתן - הוריה של ניבאל, אחיה, בני זוגם וילדיהם - משוטטים ברחובות ג׳אבליא בחיפוש אחר מקום בטוח. 
...
צווי הפינוי שמוציא הצבא בתחילת ספטמבר, ימים ספורים לאחר שמשפחתה של ניבאל מגיעה לעיר, דורשים מכ-1.2 מיליון בני אדם לעקור.

המשפחה נעקרת שוב, הפעם דרומה, אל מתחם אוהלים בדיר אל-בלח.  
...
גם עם שוך ההפצצות, ניבאל, ריתא ומשפחתן נותרים בסכנת חיים יומיומית. המחסור בקורת גג, יחד עם ההתמודדות עם האובדן של בני משפחתה, הרס הבית והנכות הקשה ממשיכים להותיר משקעים בנפשה ובגופה של ניבאל. 

היא מתארת חוסר יכולת מוחלט לדמיין עתיד עבור עצמה ועבור ריתא.
...
[](about:blank)
**המסע של ניבאל עוד לא נגמר.** היא מנסה לבנות מחדש את חייה עם ריתא, כמו אלפי משפחות אחרות בעזה. בצלם ימשיך לעקוב אחריה, ואם יחול שינוי במצבה — נעדכן עליו בניוזלטר שלנו `הניסוח עדיין לא משהו, מציעה שנתן לשירלי לחשוב מה מתאים`:
