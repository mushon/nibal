...
{.meta}
[](svg/#intro-pre.svg/0.34,0.36,1.81/~all)
[](map/#31.41661,34.37347,10.01,37.6,0.0/~labels_he,+UNOSAT_gaza_23-10-15(poly-scale) "הערכת צפיפות בניינים שניזוקו ברצועת עזה לאחר שנתיים של מתקפה. מקור: UNOSAT")
במקביל לעקירה בשל צווי הפינוי, תושבי עזה נאלצו לעקור בשל ההפצצות התכופות של הצבא בכל רחבי הרצועה.


{.meta}
[](svg/#intro-pre.svg/0.34,0.36,1.81/~all)
[](map/#31.41661,34.37347,10.01,37.6,0.0/~labels_he,+UNOSAT_gaza_25-10-11(poly-scale) "הערכת צפיפות בניינים שניזוקו ברצועת עזה לאחר שנתיים של מתקפה. מקור: UNOSAT")
