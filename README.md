...
{.meta} 
[](svg/#intro-pre.svg/-0.02,0.02,0.5/+vimeo-1138452992)
[](map/#31.72716,34.76485,8.57,0.0,35.0/~labels_he)
...
{.meta} 
[](fg:blank)
[](map/#31.72716,34.76485,8.57,0.0,35.0/~labels_he,+pois.csv(poi,id=home))
...
{.meta} 
[](fg:blank)
[](map/#31.50989,34.46989,12.68,39.2,0.5/+unosat-damage-231015,+unosat-damage-240107,+pois.csv(poi,id=home) "הערכת צפיפות בניינים שניזוקו ברצועת עזה לאחר שלושה חודשי מתקפה. מקור: UNOSAT")
...
{.meta}
[](svg/#ceasefire_hope.svg/0.3,0.51,2.15/+@vimeo-1129871187,+vimeo-1137391158 "מתוך חשבון הטיקטוק של ניבאל")
[](bg:blank)
...
{.meta}
[](svg/#ceasefire_hope.svg/0.72,0.42,2.15/+@vimeo-1137391158  "מתוך חשבון הטיקטוק של ניבאל")
...
{.meta}
[](svg/#back_home.svg/-0.73,0.57,2.67/+@vimeo-1129860275 "תיעוד של ביתה של אלאא לאחר ההפצצה, לצד תמונות של ילדיה שנהרגו")
[](map/#31.53551,34.47021,14.64,38.4,0.0/+pois.csv(poi,id=alaa-home),+pois-he(label-main,id=alaa-home),+pois-he#2(label-main,id=couple-home))

באפריל 2025 הפציץ הצבא הישראלי את הבית הסמוך, בו חיה משפחתה של אלאא, אחותה של ניבאל. כתוצאה מההפצצה נהרגו שלושת ילדיה של אלאא: וסים, בן 10, מוהנד, בן 8, וח'וולה, בת 5. 
...
{.testimony typewriter}
באותו זמן הרגשתי שאחמד כבר לא מסוגל לדאוג לי ולריתא. הקושי לטפל בנו ולדאוג לנו למים ולאוכל עשה אותו עצבני, ולרגעים אפילו חששתי ממנו.
...
[](map/#31.53433,34.47235,14.64,38.4,0.0/+pois.csv(poi,id=home),+pois-he(label-main,id=home))
...
[](map/#31.53433,34.47235,14.64,38.4,0.0/+pois.csv(poi,id=home))
...
{.meta}
[](svg/#permanent_impermanence.svg/-0.66,1.26,3.27/+nibal_ruined_home2.jpg "אזור ביתה של ניבאל לאחר ההפצצה")
...
{.meta} 
[](map/#31.50774,34.46034,14.51,38.4,0.0/+pois.csv(poi,id=home),+pois.csv#2(poi,id=gaza-2509),+pois-he(label-main,id=home),+pois-he#2(label-main,id=gaza-2509))
...
{.meta}
[](fg:blank)
[](map/#31.43623,34.35063,10.79,0.0,39.0/+gaza-deir-al-balah(by-car):follow+,+pois.csv(poi,id=gaza-2509),+IDF_zone_090925_NEW(idf-poly),+idf-poly-outlines)
...
{.meta}
[](svg/#permanent_impermanence.svg/2.02,-1.82,5.68/+@vimeo-1139274686 "מתוך האינסטגרם של ניבאל")
[](bg:blank)
