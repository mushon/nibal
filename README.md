...
[](map/#31.53332,34.48215,14.18,37.6,0.0/~labels_he,+Gaza_border_dash,+Gaza_border_base)
שמי ניבאל. אני בת 25. עד לאוקטובר 2023, גרתי בעיירה ג׳באליא עם בעלי אחמד ובתנו התינוקת ריתא.
...
[](map/#31.53332,34.48215,14.18,37.6,0.0/~labels_he,+Gaza_border_dash,+Gaza_border_base)
בספטמבר 2022 עברנו לגור בדירה משלנו בבניין של המשפחה של אחמד, בג׳באליא, לא רחוק מהבית של ההורים שלי.  
...
נשארנו בג׳באליא למרות ההפצצות, הרעב והפחד. סבלתי מאוד בתקופה הזאת. אחמד חסר לי ולא יכולתי לדמיין את העקירה לבד עם ריתא, בלעדיו ובלי המשפחה שלי.
...
[](svg/#oct7.svg/0.01,-0.39,2/+ruined_jabalia "תושבים בוחנים אתר תקיפה ישראלית על בית בג׳באליא, 3 בינואר 2024 (REUTERS/עימאד גבון)")
[](bg:blank)
התושבים שעוד נותרו בג׳באליא תועדו מסתובבים בין ההריסות, כשהם מנסים לאסוף את מה שנותר מרכושם.
...
[](bg:blank)
החיים במחסן היו קצת יותר יציבים מאשר החיים באוהל, אבל הרגשתי חצויה. מצד אחד שמחתי להיות עם אחמד וריתא, ומצד שני, המרחק מההורים, מהאחים ומהבית שלי בג׳באליא גרם לי להרגיש בודדה ומנוכרת. התגעגעתי אליהם מאוד.
...
במחסום נצרים, אספו אותם קרובי משפחה של ניבאל. הם לקחו את אחמד לדירתם של בני הזוג, ואת ניבאל וריתא לבית הוריה בג׳באליא. 
...
{.meta}
[](fg:blank)
[](map/#31.52956,34.47932,18.24,38.4,0.0/+UNOSAT_jabalia_25-04-04(poly-scale),+pois-he.csv(label-main,id=alaa-home),+pois-he.csv#2(label-main,id=couple-home),~labels_he "הערכת נזק וחומרת פגיעה במבנים בג׳באליא עד לתחילת אפריל 2025. מקור: UNOSAT")
...
{.testimony typewriter}
[](fg:blank)
[](map/#31.52943,34.47873,16.78,38.4,0.0/+UNOSAT_jabalia_25-07-08(poly-scale),+pois.csv(poi,id=home),~labels_he "הערכת נזק וחומרת פגיעה במבנים בג׳באליא עד לתחילת יולי 2025. מקור: UNOSAT")
...
{.meta}
[](svg/#back_home.svg/-0.43,0.71,2.35/+@vimeo-1137391856,+vimeo-1137392312 "הפצצות בשכונת א-נזלה בג׳באליא, אוגוסט 2025")
[](map/#31.52943,34.47873,16.78,38.4,0.0/+pois.csv(poi,id=home),~labels_he)
...
{.testimony typewriter}
[](svg/#back_home.svg/0.03,0.51,2.35/+@vimeo-1137392312 "תושבים נעקרים משכונת א-נזלה בג׳באליא ביום ההפצצה")
[](map/#31.52947,34.47929,18.15,38.4,0.0/+pois.csv(poi,id=home),+pois.csv#2(poi,id=alaa-home),~labels_he)
...
[](bg:blank)
בהמשך, נודע לניבאל כי הבניין בו גרה רוב חייה לצד משפחתה המורחבת נהרס כליל בהפצצות הכבדות על ג׳באליא.
...
ניבאל, ריתא וכ-50 מבני משפחתן המורחבת - הוריה של ניבאל, אחיה, בני זוגם וילדיהם - צעדו ברגל מג׳באליא בחיפוש אחר מקום בטוח. 
...
{.testimony typewriter}
[](svg/#permanent_impermanence.svg/-0.66,-1.1,4.35/+home_nibal.png,~vimeo-1129867912 "ביתה של ניבאל בג׳באליא טרם תחילת המתקפה הישראלית")
[](bg:blank)
החיים שלנו נהרסו.


{.testimony typewriter}
[](svg/#permanent_impermanence.svg/-0.86,-1.59,6.21/+home_nibal_RUINED.png,~home_nibal.png "הריסות ביתה של ניבאל בג׳באליא, אוקטובר 2025")
[](bg:blank)
...
{.meta}
[](svg/#permanent_impermanence.svg/2.16,-2.2,5.41/+nibal_next_to_ruins3.jpg "ניבאל על רקע הריסות ביתה בג׳באליא")
[](bg:blank)
גם עם שוך ההפצצות, ניבאל, ריתא ובני משפחתן עדיין חשופים לסכנת חיים יומיומית. 


{.meta}
[](svg/#permanent_impermanence.svg/2.16,-2.2,5.41/+nibal_next_to_ruins1.jpg "ניבאל על רקע הריסות ביתה בג׳באליא")
[](bg:blank)
...
היא מקווה שבעזרת הפרסום תצליח לגייס כסף כדי לצאת מהרצועה ולעבור התקנה של גפיים תותבות, שיעזרו לה להחזיר לעצמה מעט מהעצמאות שאיבדה.
