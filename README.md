...
{.meta}
[](svg/#intro-pre.svg/0.34,0.36,1.81/+displacement " תושבי העיר עזה נמלטים לאחר שהצבא הורה להם להתפנות דרומה, 15 בספטמבר 2025. (רויטרס / מחמוד עיסא)")
...
כשהיא נושאת בחיקה את ריתא בת החצי שנה, ניבאל המשיכה משם לדרום הרצועה ברגל.
...
ניבאל קיבלה את הבשורה המרה על המוות של אחיינים שלה בשעה שהקשיים בינה לבין לאחמד הגיעו לשיא.
