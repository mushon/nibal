...
ב-7 באוקטובר 2023 ביצעו ארגון חמאס ופלגים חמושים פלסטינים נוספים מרצועת עזה את המתקפה הקטלנית ביותר אי פעם שתועדה נגד אזרחים ישראלים.
...
{.meta} 
[](svg/#oct7.svg/0,-1,1)
[](map/#31.63011,34.71983,8.57,24.0,41.5/+unosat-damage-231015,~labels_he,+poi[order=1] "מיפוי של הערכת ההרס ברצועת עזה לאחר השבוע הראשון למתקפה. אדום: אזור הרוס; כתום: אזור שניזוק קשה; צהוב: אזור שניזוק בינונית. מקור: UNOSAT")
...
{.meta} 
[](svg/#oct7.svg/0,-1,1)
[](map/#31.63011,34.71983,8.57,24.0,41.5/~labels_he,+unosat-damage,+poi[order=1]] "מיפוי של הערכת ההרס ברצועת עזה לאחר השבוע הראשון למתקפה. אדום: אזור הרוס; כתום: אזור שניזוק קשה; צהוב: אזור שניזוק בינונית. מקור: UNOSAT")
ניבאל המבוהלת החליטה לעבור עם ריתא לבית הוריה הסמוך.


{.meta} 
[](svg/#oct7.svg/0,-1,1)
[](map/#31.63011,34.71983,8.57,24.0,41.5/~labels_he,~s.gaza,~label-focused,~bubbles,~idf-poly-outlines,+unosat-damage,+poi[order=1]] "מיפוי של הערכת ההרס ברצועת עזה לאחר השבוע הראשון למתקפה. אדום: אזור הרוס; כתום: אזור שניזוק קשה; צהוב: אזור שניזוק בינונית. מקור: UNOSAT")
...
{.meta} 
[](map/#31.37771,34.43288,10.00,37.6,0.0/+north "!!! להחליף תמונה לאיכות מלאה")
...
{.meta} 
[](map/#31.52287,34.46534,12.90,-3.2,39.0/+family-home,+unosat-damage-231015,+cities "מיפוי של הערכת ההרס באיזור ג׳אבליא בסוף אוקטובר 2023. אדום: אזור הרוס; כתום: אזור שניזוק קשה; צהוב: אזור שניזוק בינונית. מקור: UNOSAT")
...
{.meta} 
[](img/#rafah_pre.jpeg "!!! התמונה הזו תוחלף לאיכות מלאה")
במקביל להוצאת צווי הפינוי, ישראל הגבירה את תקיפותיה ברפיח.


{.meta} 
[](map/#31.35894,34.31925,10.36,0.0,39.0/+rafah-bureij(2-by-foot):follow+,+pois(poi)[name=rafah],+pois(poi)[name=bureij],+cities,+villages,+idf-poly-outlines "!!! להחליף תמונה לאיכות מלאה")
...
{.testimony typewriter}
[](img/#bureij_pre.jpeg "!!! התמונה הזו תוחלף לאיכות מלאה")
...
{.meta}
[](map/#31.38437,34.30257,11.63,0.0,39.0/+al-zawaida-al-mawasi(2-by-foot):follow+,+al-zawaida,+al-mawasi,+cities,+villages,+idf-poly-outlines "!!! להחליף תמונה לאיכות מלאה")
...
{.meta}
[](img/#wheelchair_pre.jpeg "!!! התמונה הזו תוחלף לאיכות מלאה")
...
{.meta}
[](map/#31.43623,34.35063,10.79,0.0,39.0/+gaza-deir-al-balah(by-car):follow+,+s.gaza,+deir-al-balah,+cities,+villages,+idf-poly-outlines "!!! להחליף תמונות לאיכות מלאה")
...
{.meta}
גם עם שוך ההפצצות, ניבאל, ריתא ובני משפחתן עדיין חשופים לסכנת חיים יומיומית. החיים במחנה האוהלים, יחד עם ההתמודדות עם האובדן של בני משפחתה, הרס הבית והנכות הקשה ממשיכים להותיר משקעים בנפשה ובגופה של ניבאל.
...
{.meta thumb gofundme}
במהלך החודשים האחרונים, סיפורה של ניבאל פורסם בעיתונות וברשתות החברתיות. היא מקווה שבעזרת הפרסום תצליח לגייס כסף כדי לצאת מהרצועה ולעבור השתלה של גפיים תותבות, שיעזרו לה להחזיר לעצמה מעט מהעצמאות שאיבדה.
