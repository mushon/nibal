...
{.meta} 
[](svg/#intro-pre.svg/0.45,-0.33,0.5/+vimeo-1137388732)
...
{.meta thumb} 
[](svg/#oct7.svg/0.04,-0.06,1.77/+IDF_order_north "תושב העיר עזה מחזיק בצו פינוי שהוטל ממטוס ישראלי, המזהיר מפני ״מתקפה קרובה״ על רצועת עזה וקורא לתושבים לעבור דרומה, 13 באוקטובר 2023. (Anadolu / דועאא אל-בז)")
[](map/#31.56174,34.26564,9.50,-45.3,0.0/+north,+arrow)
צווי הפינוי ההמוניים הראשונים למתקפה, שהוצאו ב-13 לאוקטובר, הורו לכמיליון תושבי צפון הרצועה לעזוב את בתיהם ולעקור לדרום הרצועה תוך 24 שעות.
...
{.meta} 
[](svg/#oct7.svg/0.32,-0.31,1.97/+@vimeo-1136099759 "נסיעה על כביש סלאח א-דין, 14 באוקטובר 2023. (מוחמד זענון)")
...
[](map/#31.46257,34.35490,9.89,35.0,2.5/+pois.csv(poi,id=rafah))    
...
{.meta} 
[](svg/#south.svg/-1.59,-2.33,5.6/+leaving_rafah-comp2.jpg)
