...
[](map/#31.49997,34.25627,10.18,37.6,0.0/+unosat-damage-231015)
...
באותם ימים, הצבא הישראלי החל להפיץ צווי פינוי לתושבי עזה.
...
{.meta thumb} 
[](fg:blank)
[](map/#31.37125,34.28097,14.97,40.0,1.2/+wayback:20251023 "תצלום לוויין של ״האזור ההומניטרי״ באל-מוואסי, ח׳אן יונס, בינואר 2025. מקור: ESRI Wayback")
...
[](map/#31.43623,34.35063,10.79,0.0,39.0/+IDF_zone_21_25_03_25(idf-poly) "באדום: צווי הפינוי שהפציץ הצבא הישראלי לתושבי עזה בשבוע שלאחר שהפר את הפסקת האש במרץ 2025")
...
[](map/#31.53551,34.47021,14.64,38.4,0.0/+pois.csv(poi,id=alaa-home),+pois.csv#2(poi,id=couple-home))
...
{.meta}
[](fg:blank)
[](map/#31.41505,34.39181,9.91,38.4,0.0/+IDF_zone_191025 "באדום: השטח שנותר בשליטת ישראל לפי השלב הראשון בהסכם הפסקת האש ")
...
{.meta}
[](svg/#permanent_impermanence.svg/-0.91,-0.24,1.72/+refugees_end-comp.jpg "תושבי העיר עזה נמלטים לאחר שהצבא הישראלי הורה להם להתפנות דרומה, 15 בספטמבר 2025. (רויטרס / מחמוד עיסא)")
